##Program to calculate the total bispectrum signal in the flatsky limit.
## Uses snr calculations from subroutine bispec_lens_snr in bstool.f90
# Use environment full_bs_lensplus 
# output saved to /home/amb257/kappa_bispec/optimal_est/full_bispec/flat_bispectrum.txt
...
cl_var = ocl + norm_phi
snr = basic.bispec.bispeclens_snr(cpmodel,fitform,z,dz,zs,lmin,lmax,cl_var,k,pk[0],btype=btype, ro=2)
