...
def integrand_N2(ell, L1, L2, L3, cl_phi_interp, lcl_interp, ocl_interp, ellmin, ellmax):
...
for lensingL in lensingLarray:
    ...
    integrand_function = lambda ell: integrand_N2(ell, L1, L2, L3, cl_phi_interp, lcl_interp, ctot_interp, ellmin, ellmax) #second ps should be ctot_interp but changed to noiseless to cf giorgio's results 6/9/24
